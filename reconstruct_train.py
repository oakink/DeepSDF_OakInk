...
if __name__ == "__main__":
    ...
    latent_code = torch.load(
        os.path.join(args.experiment_directory, "network", ws.latent_codes_subdir, f"{args.checkpoint}.pth")
    )
    for ii, npz in enumerate(npz_filenames):
        ...
        latent = latent_code["latent_codes"]["weight"][ii][None].cuda()
